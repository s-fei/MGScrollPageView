...
/** 排除数组中的手势冲突 例如@[@"StepSlider"] */
@property (strong, nonatomic) NSArray *excludeGestureClasss;


/** 是否显示滚动条的背景 默认为NO*/
@property (assign, nonatomic, getter=isShowLineBgView) BOOL showLineBgView;

/** 滚动条的背景颜色*/
@property (strong, nonatomic) UIColor *lineBgColor;

/** 滚动条的背景 默认为1 */
@property (assign, nonatomic) CGFloat lineBgHeight;


/** 滚动条宽度 默认为0(自适应) >0 表示固定宽度 */
