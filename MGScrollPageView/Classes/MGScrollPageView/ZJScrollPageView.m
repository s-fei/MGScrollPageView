...
-(void)layoutSubviews{
    ...
    self.segmentView.frame = CGRectMake(0, 0, self.bounds.size.width - self.segmentStyle.rightMargin,self.segmentStyle.segmentHeight);
    self.contentView.frame = CGRectMake(0, CGRectGetMaxY(self.segmentView.frame), self.bounds.size.width, self.bounds.size.height - CGRectGetMaxY(self.segmentView.frame)) ;
}
